...
rba = False     # residual based adaptivity
sa  = False     # self adaptive weights
FF  = True      # Fourier feature embeddings

save_folder = './outputs/kovasznay_FF_Re10_post_process/'
# save_folder = './outputs/kovasznay_FF_Re10/'
print(save_folder)
