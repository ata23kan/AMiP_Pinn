...
NN_name = 'square_elastic_long_1'
fileDir = 'solutions/top_deform/' + NN_name + '_hardBC_results.pickle'
with open(fileDir, 'rb') as f:
	X_hard, Y_hard, Ex_pred, Ey_pred = pickle.load(f)
...
fileName = 'figures/square_squeeze_hard.vtu'
