...
class mesh_motion_laplacian:
  ...
  def __init__(self, WALL_id, line_id, res_id,
    ...
    self.loss_LINE = tf.reduce_mean(tf.square(self.X_LINE_pred - self.x_LINE_tf)) \
                   + tf.reduce_mean(tf.square(self.Y_LINE_pred - (self.y_LINE_tf + self.translation)))
